...
- isMerged: boolean. AI 추천 단계가 위에 제공된 "전체 로드맵"의 어느 단계와도 제목·핵심 내용 면에서 실질적으로 동일하면 true. 바로 다음 단계뿐 아니라 아직 학습하지 않은 모든 단계를 비교 대상에 포함한다. "실질적 동일"이란 제목이나 핵심 설명이 같은 개념을 다루는 것을 의미한다.
